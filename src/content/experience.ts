...
const en: Role[] = [
  {
    ...
    summary: [
      ...
      'Sole technical counterpart to the client: gathered requirements, recommended the platform and hosting setup, then delivered and handed over the solution.'
    ],
  ...
  },
  {
    ...
    mode: 'Hybrid',
    summary: [
      'Modernized digital platforms for one of Sweden\'s leading real estate agencies—with the customer at the heart of every step.',
      'Led accessibility initiatives in accordance with WCAG to make the platform inclusive for all users.',
      'Worked closely with the business to ensure every technical solution addressed a real business need—not just added another line of code.',
    ],
...
const sv: Role[] = [
  {
    ...
    mode: 'På plats',
    summary: [
      'Formgav, byggde och lanserade vanityclinics.se, en Next.js-sajt i produktion för en estetisk klinik i Stockholm — med eget ansvar för hela uppdraget från kundbrief till design, bygge, hosting och överlämning.',
      ' Kundens enda tekniska motpart: samlade in krav, rekommenderade plattform och hostinglösning samt levererade och lämnade över lösningen.'
    ],
    tags: ['Next.js', 'React', 'TypeScript'  ],
  },
  {
  ...
  },
  {
    ...
    mode: 'På plats',
    summary: [
      'Byggde digitala köpupplevelser i Salesforce Commerce Cloud för internationella varumärken som Urbanears, Marshall och Plantagen.',
      'Samarbetade nära projektintressenter för att förstå vad som faktiskt drev konvertering, och prioriterade affärsvärde framför teknik för teknikens skull.'
    ],
    tags: ['Salesforce', 'JSON', 'ES6', 'HTML5', 'jQuery', 'CSS'],
  },
  {
