...
const en: SkillGroup[] = [
  { label: 'Languages & frameworks', items: ['Next.js', 'TypeScript', 'React', 'JavaScript', '.NET', 'HTML', 'CSS', 'JSON'] },
  { label: 'Platforms', items: ['Salesforce Commerce Cloud', 'PWA', 'SaaS'] },
  { label: 'Practice', items: ['Accessibility (WCAG)', 'Agile', 'UX', 'Performance'] },
];

const sv: SkillGroup[] = [
  { label: 'Språk & ramverk', items: ['Next.js', 'TypeScript', 'React', 'JavaScript', '.NET', 'HTML', 'CSS', 'JSON'] },
